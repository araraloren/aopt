...
impl<'a> CoteGenerator<'a> {
    ...
    pub fn gen_new_app_define(&self, ident: &Ident) -> TokenStream {
        quote! {
            ...
            pub struct #ident<Set, Inv, Ser>(cote::CoteParser<Set, Inv, Ser>);

            impl<Set, Inv, Ser> std::ops::Deref for #ident<Set, Inv, Ser> {
                type Target = cote::CoteParser<Set, Inv, Ser>;
            ...
            impl<Set, Inv, Ser> std::ops::DerefMut for #ident<Set, Inv, Ser> {

...
impl<'a> Analyzer<'a> {
    ...
    pub fn gen_all(&self) -> syn::Result<TokenStream> {
        ...
        Ok(quote! {
            ...
            #[doc=concat!("Automatic generated by cote-derive for [`", stringify!(#ident), "`].")]
            impl #impl_sd cote::ExtractFromSetDerive<'set, S>
                for #ident #type_sd #where_sd {
                fn try_extract(set: &'set mut S) -> Result<Self, aopt::Error> where Self: Sized {
                    #try_extract
                }
            }
    ...
    pub fn gen_where_for_into_parser(
        ...
        let default_where = quote! {
            where
            Ser: aopt::ser::ServicesValExt + aopt::prelude::ErasedTy + aopt::prelude::ADefaultVal,
            Set: aopt::prelude::Set + aopt::prelude::ErasedTy  + aopt::prelude::ADefaultVal,
            Inv: aopt::ctx::HandlerCollection<'inv, Set, Ser> + aopt::prelude::ErasedTy + aopt::prelude::ADefaultVal,
    ...
    pub fn where_clause_for_policy() -> TokenStream {
        quote! {
            ...
            P: aopt::prelude::Policy + aopt::prelude::PolicySettings + Default,
            P::Ser: aopt::ser::ServicesValExt + aopt::prelude::ADefaultVal + aopt::prelude::ErasedTy,
            P::Set: aopt::prelude::Set + aopt::prelude::ADefaultVal + aopt::prelude::ErasedTy,
            P::Inv<'inv>: aopt::ctx::HandlerCollection<'inv, P::Set, P::Ser>  + aopt::prelude::ADefaultVal + aopt::prelude::ErasedTy,
    ...
    pub fn where_clause_for_parser() -> TokenStream {
        quote! {
            ...
            Set: aopt::prelude::Set + aopt::prelude::ADefaultVal + aopt::prelude::ErasedTy,
            Inv: aopt::ctx::HandlerCollection<'inv, Set, Ser> + aopt::prelude::ADefaultVal + aopt::prelude::ErasedTy,
            aopt::prelude::SetCfg<Set>: aopt::prelude::Config + aopt::prelude::ConfigValue + Default,
        }
    }
    ...
    pub fn gen_parser_interface(&self) -> syn::Result<TokenStream> {
        ...
        Ok(quote! {
            pub fn gen_parser<'inv>() ->
                Result<cote::CoteParser<
                        <#policy_ty as aopt::prelude::Policy>::Set,
                        <#policy_ty as aopt::prelude::Policy>::Inv<'inv>,
                        <#policy_ty as aopt::prelude::Policy>::Ser>, aopt::Error> {
                Self::gen_parser_with()
            }

            pub fn gen_parser_with<'inv, Set, Inv, Ser>() -> Result<cote::CoteParser<Set, Inv, Ser>, aopt::Error>
                #where_clause_parser {
            ...
            pub fn gen_cote_app<'inv>() -> Result<cote::CoteApp<'inv, #policy_ty>, aopt::Error> {
                Self::gen_cote_app_with(Self::gen_policy())
            }

            pub fn gen_cote_app_with<'inv, P>(policy: P) -> Result<cote::CoteApp<'inv, P>, aopt::Error> #where_clause {
                Ok(cote::CoteApp::new_with_parser(policy, Self::gen_parser_with::<P::Set, P::Inv<'inv>, P::Ser>()?))
            }
            ...
            /// Parsing the given arguments and return the [`GetoptRes`](aopt::GetoptRes).
            pub fn parse_args<'inv>(args: aopt::prelude::Args)
                -> Result<aopt::GetoptRes<<#policy_ty as aopt::prelude::Policy>::Ret,
                cote::CoteParser<<#policy_ty as aopt::prelude::Policy>::Set, <#policy_ty as aopt::prelude::Policy>::Inv<'inv>,
                    <#policy_ty as aopt::prelude::Policy>::Ser>>, aopt::Error> {
            ...
            pub fn parse(args: aopt::prelude::Args) -> Result<Self, aopt::Error> {
                ...
                if ret.status() {
                    ...
                    let mut rctx = parser.service().take_rctx()?;
            ...
            /// Parsing the given arguments and return the [`GetoptRes`](aopt::GetoptRes).
            pub fn parse_env_args_with<'inv, P>(policy: &mut P)
                -> Result<aopt::GetoptRes<<P as aopt::prelude::Policy>::Ret,
                    cote::CoteParser<<P as aopt::prelude::Policy>::Set, <P as aopt::prelude::Policy>::Inv<'inv>,
                    <P as aopt::prelude::Policy>::Ser>>, aopt::Error> #where_clause {
    ...
    pub fn gen_new_app_for_struct(&self) -> syn::Result<TokenStream> {
        ...
        Ok(quote! {
            ...
            impl<'a, 'inv, Set, Inv, Ser> #new_app_type<'a, Set, Inv, Ser> #where_clause_for_parser {
                ...
                pub fn sync_rctx<R>(&mut self, ret: &Result<R, aopt::Error>, sub_parser: bool) 
                    -> Result<&mut Self, aopt::Error> where R: Into<bool> {
                ...
                pub fn display_sub_help(&self, names: &[String]) -> Result<(), aopt::Error> {
